        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start  -->
                    <form action="<?php echo base_url("service/update/$item->id"); ?>" method="post"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       id="title" name="title"
                                       placeholder="Choose Service Title" value="<?=$item->title;?>">
                                       <input type="hidden" name="pictureName" value="<?=$item->image;?>">
                                       <input type="hidden" name="slug" value="<?=$item->url;?>">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input class="form-control <?=($validation->hasError('price')) ? 'is-invalid' : ''?>" type="number" name="price" data-prefix="₺"
                                                   ...
                                                   data-decimals="2" value="<?=$item->price;?>" step="0.1"/>
                                            <div class="invalid-feedback">
                                                <?=$validation->getError('price')?>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <img src="/assets/uploads/<?=$item->image;?>" class="img-thumbnail img-preview" alt="preview">
                                        </div>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="<?=base_url("service");?>" class="btn btn-danger btn-outline">Cancel</a>
                                </div>
                    </form>
                </div>
                <!-- /.card -->
